...
namespace Piranha
{
	...
	/// </summary>
	internal class Db : Data.BaseContext<Db>
	{
		#region Db sets
		/// <summary>
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder) {
			...
			Models.Page.OnModelCreating<Models.Page>(modelBuilder);
			...
			Models.PageType.OnModelCreating<Models.PageType>(modelBuilder);
			...
			// Permission
			modelBuilder.Entity<Models.Permission>().ToTable("PiranhaPermissions");
			modelBuilder.Entity<Models.Permission>().Property(p => p.Name).HasMaxLength(128).IsRequired();
			modelBuilder.Entity<Models.Permission>().Property(p => p.Description).HasMaxLength(255);
			modelBuilder.Entity<Models.Permission>().Property(p => p.Roles).HasMaxLength(128);

			// Post
			modelBuilder.Entity<Models.Post>().ToTable("PiranhaPosts");
			Models.Post.OnModelCreating<Models.Post>(modelBuilder);
			...
			Models.PostType.OnModelCreating<Models.PostType>(modelBuilder);
